...
The visualField package provides functions for more sophisticated plotting, which will be explained later. \textbf{These functions automatically take care that right eyes and left eyes are plotted correctly.}
